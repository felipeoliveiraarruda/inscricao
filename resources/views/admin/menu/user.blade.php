<div class="list-group">
    ...
    @if ($total == 0)
        ...
        <a href="#" class="list-group-item list-group-item-action">Experiência Profissional</a>
        <a href="#" class="list-group-item list-group-item-action">Experiência Em Ensino</a>
    @endif
</div>