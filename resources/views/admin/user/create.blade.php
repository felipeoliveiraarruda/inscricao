    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="list-group">
                <a href="/admin/usuario/create" class="list-group-item list-group-item-action active">Novo Usuário</a>
            </div>
        </div>      
        ...
        <div class="col-sm-9">
            ...
            <form class="needs-validation" novalidate method="POST" action="/admin/usuario/salvar">
                @csrf
