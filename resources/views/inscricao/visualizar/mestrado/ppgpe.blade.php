@if (Session::get('total')['mestrado'] >= 6 && $total >= 6 && Session::get('total')['pre-projeto'] > 0 && !empty($requerimento) && $status == 'N')
        <!-- Validation Errors -->
    ...
    <tbody>
        <tr>
            <td>1.1 Requerimento de Inscrição (Arquivo será gerado após a submissão dos documento obrigatórios)<span class="text-danger">*</span>            
                @if (Session::get('total')['mestrado'] >= 6 && $total >= 6 && Session::get('total')['pre-projeto'] > 0)     
