    ...
    <div class="row justify-content-center">
        ...
        <div class="col-sm-9">
            <div class="card bg-default">
                <h5 class="card-header">Editar Foto 3x4</h5>
                
                <div class="card-body">
                    <!-- Validation Errors -->
                    <x-auth-validation-errors class="text-danger mb-4" :errors="$errors" />
                    
                    <form class="needs-validation" novalidate method="POST" action="imagem/{{ $arquivo->codigoArquivo }}" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
