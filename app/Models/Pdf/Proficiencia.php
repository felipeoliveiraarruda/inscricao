...
class Proficiencia extends Fpdf
{
    function Header()
    {
        $this->Image(asset("images/cabecalho/proficiencia.png"), 0, 5, 290);
    }
    ...
    function Footer()
    {
        ...
        $this->Cell(130, 8, utf8_decode(''), 0, 0, 'C');
        $this->Cell(150, 8, utf8_decode('Prof. Dr. Clodoaldo Saron'), 0, 0, 'C');
        $this->Ln();

        $this->Cell(130, 8, utf8_decode(''), 0, 0, 'C');
        $this->Cell(150, 8, utf8_decode('Coordenador da CCP-PPGEM, EEL/USP'), 0, 0, 'C');
        $this->Ln();
    }
