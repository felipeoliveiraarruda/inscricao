...
class Regulamentacao extends Fpdf
{
    function Header()
    {
		$this->Image(asset("images/cabecalho/ppgem.png"), 10, 10, 190);
		$this->Ln(35);
    }
    ...
    function Footer()
    {
		...
		$this->Cell(53, 8, utf8_decode('Ciente CCP - PPGPE : '), 0, 0, 'L');
        $this->Cell(80, 8, utf8_decode(''), 'B', 0, 'C');
        $this->Cell(37, 8, utf8_decode(''), 0, 0, 'C');
    }
